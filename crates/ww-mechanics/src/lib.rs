...
//! Ships with four reference systems: 2d20 (Modiphius), Trophy Gold,
//! Blood & Honor, and Mothership (roll-under).
...
pub use resolution::{CountSuccesses, HighestDie, Outcome, ResolutionStrategy, RollUnder, SumPool};
